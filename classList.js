...
if("classList" in element) {
	...
	if(!element.classList.contains(2)) {
		...
		}.call((element = view["DOMTokenList"].prototype), element["add"], element["remove"], Array.prototype.forEach);
	}
}
else {
	void function(view) {
